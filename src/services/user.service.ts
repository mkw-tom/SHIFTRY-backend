...
import { createDataOwnerToStore, createDataStaffToStore, createUser } from "../repositories/user.repository";
import { CreateUserInput, LineUser, UserRole } from "../types/userTypes";


/// ✅　初回ログイン時のデータ追加 & メッセージ送信
export const firstLoginUserFunc = async (userProfile: LineUser, storeId: string, role: UserRole, groupId: string) => {
  try {
